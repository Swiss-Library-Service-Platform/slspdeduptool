"""
PRODUCTION Django settings for dedup project.

The environment variable are set in Apache configuration.
No need of dotenv in production.
"""
import os
